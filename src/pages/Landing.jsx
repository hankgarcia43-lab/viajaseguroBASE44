      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <header className="flex items-center justify-between px-6 py-4">
            ...
            <button onClick={() => base44.auth.redirectToLogin(window.location.origin + createPageUrl('SearchRoutes'))}>
          ...
          <div className="px-6 pt-16 pb-24 text-center">
            ...
            >
              ...
              <button onClick={() => base44.auth.redirectToLogin(window.location.origin + createPageUrl('DriverOnboarding'))}>
